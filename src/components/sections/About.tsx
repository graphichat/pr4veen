    ...
    skills: [
      {
        ...
        tooltip: "Conducted 12+ user interviews per product cycle at HealthPlix",
      },
      {
        name: "Design Thinking",
        tooltip: "Applied double diamond framework across 6+ product redesigns",
      },
      {
        name: "Design Reviews & Testing",
        tooltip: "Led bi-weekly design critique and usability test sessions",
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        tooltip: "Built design systems from scratch at HealthPlix and IQLine",
      },
      {
        name: "Wireframing & Prototyping",
        tooltip: "Delivered high-fidelity prototypes for usability testing and dev handoff",
      },
      {
        name: "Framer & 3D Spline",
        tooltip: "Used for interactive motion prototypes and 3D UI explorations",
      },
      {
        name: "Design Tokens & PRDs",
        tooltip: "Authored product requirement documents and token documentation",
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        tooltip: "Managed design reviews with C-suite and engineering leads",
      },
      {
        name: "Cross-Functional Collaboration",
        tooltip: "Worked alongside product, engineering, and clinical teams",
      },
      {
        name: "Design System Development",
        tooltip: "Created token-based design systems used across multiple products",
      },
    ],
  },
];
      ...
      <section id="about" className="px-4 py-20 bg-muted/20">
        <div className="mx-auto max-w-6xl">
          ...
          <MotionDiv animation="slideUp" trigger="inView" className="mb-12 text-center">
            <div className="mb-6 flex justify-center">
              <div className="relative">
                ...
                >
                  {/* Replace with real photo: <img src="/images/praveen-headshot.jpg" alt="Praveen Kumar N" className="h-full w-full object-cover" /> */}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Skills Card — categorised with tooltips */}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {category.skills.map((skill) => (
                            <Tooltip key={skill.name} content={skill.tooltip}>
                              <Badge
                                variant="secondary"
                                className="text-sm font-medium cursor-default transition-all hover:scale-105"
                              >
                                {skill.name}
                              </Badge>
                            </Tooltip>
